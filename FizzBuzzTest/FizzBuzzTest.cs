...
namespace FizzBuzzTest
{
    public class GameFizzBuzzTest
    {
        ...
        [Fact]
        public void Should_return_Buzz_given_multiple_of_5_and_7()
        {
            //given
            GameFizzBuzz game = new GameFizzBuzz();
            int number = 70;
        ...
        [Fact]
        public void Should_return_Buzz_given_multiple_of_3_5_and_7()
        {
            //given
            GameFizzBuzz game = new GameFizzBuzz();
            int number = 105;
        ...
        [Fact]
        public void Should_return_Fizz_given_numbers_contain_3()
        {
            //given
            GameFizzBuzz game = new GameFizzBuzz();
            int number = 13;
